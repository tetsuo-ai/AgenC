...
function buildBackgroundRunTraceIds(
...
function refreshDerivedBudgetState(run: ActiveBackgroundRun): void {
  run.budgetState = {
    ...run.budgetState,
...
function resolveWorkerAffinityKey(
  run: {
    readonly sessionId: string;
