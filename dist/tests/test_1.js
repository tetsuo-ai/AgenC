...
describe("test_1", () => {
    ...
    let secondSigner; // Required for protocol initialization (fix #556)
    let thirdSigner; // Required for multisig threshold >= 2 (fix HIGH-6)
    let creator;
    let worker1;
    let worker2;
    let worker3;
    ...
    function deriveClaimPda(taskPda, workerPubkey) {
        return (0, test_utils_1.deriveClaimPda)(taskPda, workerPubkey, program.programId);
    }
    ...
    async function initializeWorkerPool() {
        ...
        for (let i = 0; i < WORKER_POOL_SIZE; i++) {
            ...
            wallets.push(wallet);
            (0, litesvm_helpers_1.fundAccount)(svm, wallet.publicKey, 10 * web3_js_1.LAMPORTS_PER_SOL);
        }
        ...
        const registerPromises = wallets.map(async (wallet, i) => {
            ...
            await program.methods
                .registerAgent(Array.from(agentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE | test_utils_1.CAPABILITY_INFERENCE), `https://pool-worker-${i}.example.com`, null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 10))
                .accountsPartial({
                agent: agentPda,
    ...
    async function createFreshWorker(capabilities = test_utils_1.CAPABILITY_COMPUTE) {
        ...
        await program.methods
            .registerAgent(Array.from(agentId), new bn_js_1.default(capabilities), `https://test-worker-${testAgentCounter}.example.com`, null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 10))
            .accountsPartial({
            agent: agentPda,
            protocolConfig: protocolPda,
            authority: wallet.publicKey,
    ...
    before(async () => {
        ...
        secondSigner = web3_js_1.Keypair.generate(); // Required for protocol initialization (fix #556)
        thirdSigner = web3_js_1.Keypair.generate(); // Required for multisig threshold >= 2 (fix HIGH-6)
        ...
        for (const wallet of wallets) {
            (0, litesvm_helpers_1.fundAccount)(svm, wallet.publicKey, airdropAmount);
        }
        try {
            ...
            const minStake = new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100); // 0.01 SOL = 10_000_000 lamports
        ...
        // Disable rate limiting for tests (cooldowns=0, per-24h=unlimited)
        ...
        for (const agent of agents) {
            try {
                await program.methods
                    .registerAgent(Array.from(agent.id), new bn_js_1.default(agent.capabilities), agent.endpoint, null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100))
                    .accountsPartial({
        ...
        for (const agent of agentsToCheck) {
            ...
            try {
                ...
                if (agentAccount.status && "inactive" in agentAccount.status) {
                    (0, litesvm_helpers_1.advanceClock)(svm, 61); // satisfy update cooldown
                    await program.methods
    ...
    describe("create_task Happy Paths", () => {
        it("Exclusive task creation with Open state", async () => {
            ...
            await program.methods
                .createTask(Array.from(taskId001), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Exclusive task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Collaborative task with required_completions validation", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId002), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Collaborative task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Competitive task with multiple slots", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId003), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Competitive task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 5, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COMPETITIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Reward transfer to escrow validation", async () => {
            ...
            await program.methods
                .createTask(Array.from(taskId004), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Reward validation task".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
            ...
            (0, chai_1.expect)(creatorBalanceBefore - creatorBalanceAfter).to.be.closeTo(rewardAmount, 5000000);
        });
        it("Zero-reward task handling - rejects zero reward", async () => {
            ...
            try {
                await program.methods
                    .createTask(Array.from(taskId005), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zero reward task".padEnd(64, "\0")), new bn_js_1.default(0), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
                0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    ...
                    .signers([creator])
                    .rpc();
                chai_1.expect.fail("Should have rejected zero-reward task");
            }
            catch (e) {
                const anchorError = e;
                (0, chai_1.expect)(anchorError.error?.errorCode?.code).to.equal("InvalidReward");
            }
        });
    });
    describe("create_task Rejection Cases", () => {
        it("Non-creator authority rejection", async () => {
            ...
            try {
                await program.methods
                    .createTask(Array.from(taskId006), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Unauthorized task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        it("max_workers == 0 rejection", async () => {
            ...
            try {
                await program.methods
                    .createTask(Array.from(taskId007), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zero workers task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 0, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        it("Past deadline rejection", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            const pastDeadline = (0, litesvm_helpers_1.getClockTimestamp)(svm) - 3600;
            try {
                await program.methods
                    .createTask(Array.from(taskId008), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Past deadline task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, new bn_js_1.default(pastDeadline), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        it("Invalid task type rejection", async () => {
            ...
            try {
                await program.methods
                    .createTask(Array.from(taskId009), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Invalid type task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, new bn_js_1.default(0), 99, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
    ...
    describe("claim_task Happy Paths", () => {
        it("Single claim on Open task", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId010), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Claimable task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Multiple claims on collaborative task", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId011), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Multi-claim task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 33), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Additional claims on InProgress task", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId012), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("InProgress claim task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 33), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
            ...
            (0, chai_1.expect)(task.currentWorkers).to.equal(3);
        });
    });
    describe("claim_task Rejection Cases", () => {
        it("Non-worker authority rejection", async () => {
            ...
            const unauthorized = web3_js_1.Keypair.generate();
            await program.methods
                .createTask(Array.from(taskId013), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Unauthorized claim task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Inactive agent rejection", async () => {
            ...
            await program.methods
                ...
                .rpc();
            await program.methods
                .createTask(Array.from(taskId014), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Inactive agent task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Insufficient capabilities rejection", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId015), new bn_js_1.default(1 << 5), // Requires capability that worker doesn't have
            Buffer.from("Capability check task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Claim on Completed task rejection", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId016), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Pre-complete task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Claim on Cancelled task rejection", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId017), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancel before claim task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Claim after deadline rejection", async () => {
            ...
            try {
                await program.methods
                    .createTask(Array.from(taskId019), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Past deadline task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, new bn_js_1.default(pastDeadline), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        it("Claim when fully claimed rejection", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId020), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Full capacity task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Claim with 10 active tasks rejection", async () => {
            ...
            await program.methods
                .createTask(Array.from(taskId021), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Active limit task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
    ...
    describe("Lifecycle & Adversarial", () => {
        it("Completed task cannot be claimed", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId022), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Complete then claim task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Cancelled task cannot be claimed", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId023), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancel before claim task 2".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Open to InProgress state transition", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId024), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("State transition task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("InProgress persistence on additional claims", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId025), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Multi-claim persistence task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 33), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
        ...
        it("Worker cannot claim same task twice", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId026), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Double claim task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
    ...
    describe("Design-Bounded Invariants", () => {
        it("Worker count max limit (design-bounded: max 100)", async () => {
            ...
            await program.methods
                .createTask(Array.from(taskId027), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Worker count test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 100, // Max allowed is 100
            (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
                ...
                .rpc();
            const task = await program.account.task.fetch(taskPda);
            (0, chai_1.expect)(task.maxWorkers).to.equal(100);
        });
        it("Active task count overflow prevention (design-bounded: u8 max 10)", async () => {
            ...
            (0, chai_1.expect)(agent.activeTasks).to.be.at.most(10);
        });
        it("Complete task and verify payout (Happy Path)", async () => {
            ...
            // 1. Create
            await program.methods
                .createTask(Array.from(taskIdPayout), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Payout check".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
            ...
            (0, chai_1.expect)(balanceGain).to.be.above(workerReward - 100000); // Allow 0.0001 SOL for tx fees
        ...
        it("PDA-based double claim prevention (design-bounded: unique seeds)", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId028), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("PDA double claim test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
            0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
    ...
    function deriveStatePda(authority, stateKey) {
        return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("state"), authority.toBuffer(), stateKey], program.programId)[0];
    }
    // Helper function to derive dispute PDA
    function deriveDisputePda(disputeId) {
        return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("dispute"), disputeId], program.programId)[0];
    }
    // Helper function to derive vote PDA
    function deriveVotePda(disputePda, arbiterPda) {
        return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("vote"), disputePda.toBuffer(), arbiterPda.toBuffer()], program.programId)[0];
    }
    // Helper function to derive authority vote PDA (for Sybil attack prevention)
    function deriveAuthorityVotePda(disputePda, authority) {
    ...
    describe("Issue #19: Task Lifecycle State Machine Tests", () => {
        describe("Valid State Transitions", () => {
            it("Open → InProgress (via first claim)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Lifecycle test Open->InProgress".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("InProgress → Completed (via complete)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Lifecycle test InProgress->Completed".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Open → Cancelled (via cancel by creator)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Lifecycle test Open->Cancelled".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("InProgress → Cancelled (expired deadline + no completions)", async () => {
                ...
                const shortDeadline = (blockTime || (0, litesvm_helpers_1.getClockTimestamp)(svm)) + 4;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Lifecycle test expired cancel".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 2, // max 2 workers
                new bn_js_1.default(shortDeadline), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, litesvm_helpers_1.advanceClock)(svm, 10);
        ...
        describe("Invalid State Transitions", () => {
            it("Completed → anything: cannot claim completed task", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Completed immutable test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Completed → anything: cannot cancel completed task", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Completed no cancel test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cancelled → anything: cannot claim cancelled task", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancelled immutable test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cancelled → anything: cannot complete on cancelled task", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancelled no complete test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cancelled → anything: cannot cancel already cancelled task", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Double cancel test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("InProgress → Open: cannot revert to Open state (no such instruction)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("No revert to Open test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Completed task: cannot double-complete same claim", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Double complete test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("Terminal State Immutability", () => {
            it("Completed is terminal - no state changes possible", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Terminal Completed test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cancelled is terminal - no state changes possible", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Terminal Cancelled test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
    ...
    describe("Issue #20: Authority and PDA Validation Tests", () => {
        describe("register_agent", () => {
            it("Rejects registration with wrong authority (signer mismatch)", async () => {
                ...
                const wrongSigner = web3_js_1.Keypair.generate();
                // Fund wrong signer
                (0, litesvm_helpers_1.fundAccount)(svm, wrongSigner.publicKey, 1 * web3_js_1.LAMPORTS_PER_SOL);
                ...
                await program.methods
                    .registerAgent(Array.from(newAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://test.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 10))
                    .accountsPartial({
                    agent: agentPda,
                    protocolConfig: protocolPda,
                ...
                const agent = await program.account.agentRegistration.fetch(agentPda);
                (0, chai_1.expect)(agent.authority.toString()).to.equal(wrongSigner.publicKey.toString());
            });
        });
        describe("update_agent", () => {
            it("Rejects update by non-owner", async () => {
                const nonOwner = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, nonOwner.publicKey, 1 * web3_js_1.LAMPORTS_PER_SOL);
                // Try to update agent1 (owned by worker1) with non-owner signer
                try {
                    await program.methods
                        .updateAgent(new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE | test_utils_1.CAPABILITY_INFERENCE), null, null, null)
                        .accountsPartial({
            ...
            it("Rejects update with mismatched authority account", async () => {
                ...
                try {
                    await program.methods
                        .updateAgent(new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), null, null, null)
                        .accountsPartial({
                        agent: deriveAgentPda(agentId1),
        ...
        describe("deregister_agent", () => {
            it("Rejects deregistration by non-owner", async () => {
                ...
                const deregOwner = web3_js_1.Keypair.generate();
                const nonOwner = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, deregOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                (0, litesvm_helpers_1.fundAccount)(svm, nonOwner.publicKey, 1 * web3_js_1.LAMPORTS_PER_SOL);
                // Register agent
                await program.methods
                    .registerAgent(Array.from(deregAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://dereg-test.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 10))
                    .accountsPartial({
                    agent: deregAgentPda,
                    protocolConfig: protocolPda,
        ...
        describe("create_task", () => {
            it("Rejects task creation with wrong protocol_config PDA", async () => {
                ...
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                const wrongProtocol = web3_js_1.Keypair.generate().publicKey;
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong protocol task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
        ...
        describe("claim_task", () => {
            it("Rejects claim with wrong worker authority", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong authority claim test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Rejects claim with wrong agent PDA", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong agent PDA claim test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("complete_task", () => {
            it("Rejects completion with wrong worker authority", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong authority complete test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Rejects completion with wrong treasury", async () => {
                ...
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                const wrongTreasury = web3_js_1.Keypair.generate();
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong treasury complete test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Rejects completion with wrong claim PDA", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong claim PDA complete test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("cancel_task", () => {
            it("Rejects cancellation by non-creator", async () => {
                ...
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                const nonCreator = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, nonCreator.publicKey, 1 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Non-creator cancel test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Does not reopen cancelled task when claim expires (zombie task fix #138)", async () => {
                ...
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zombie task fix test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, new bn_js_1.default(shortDeadline), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("update_state", () => {
            it("Rejects state update with wrong agent authority", async () => {
                ...
                try {
                    await program.methods
                        .updateState(Array.from(stateKey), Array.from(stateValue), new bn_js_1.default(0))
                        .accountsPartial({
                        state: statePda,
            ...
            it("Allows state update with correct authority", async () => {
                ...
                await program.methods
                    .updateState(Array.from(stateKey), Array.from(stateValue), new bn_js_1.default(expectedVersion))
                    .accountsPartial({
                    state: statePda,
                    agent: deriveAgentPda(agentId1),
                    authority: worker1.publicKey,
                ...
                (0, chai_1.expect)(state.version.toNumber()).to.equal(expectedVersion + 1);
            });
        });
        describe("initiate_dispute", () => {
            it("Rejects dispute initiation with wrong agent authority", async () => {
                ...
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Dispute authority test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("vote_dispute", () => {
            ...
            before(async () => {
                ...
                arbiter = web3_js_1.Keypair.generate();
                arbiterAgentId = makeAgentId("arbiter");
                arbiterAgentPda = deriveAgentPda(arbiterAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, arbiter.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(arbiterAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_ARBITER | test_utils_1.CAPABILITY_COMPUTE), "https://arbiter.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
            ...
            it("Rejects vote with wrong arbiter authority", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Vote authority test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Rejects vote by non-arbiter (lacks ARBITER capability)", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Non-arbiter vote test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("resolve_dispute", () => {
            it("Rejects resolution before voting ends", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Early resolution test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Rejects resolution with insufficient votes (no votes cast)", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("No votes test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(typeof dispute.votesFor === "object"
                    ? dispute.votesFor.toNumber()
                    : dispute.votesFor).to.equal(0);
                (0, chai_1.expect)(typeof dispute.votesAgainst === "object"
                    ? dispute.votesAgainst.toNumber()
                    : dispute.votesAgainst).to.equal(0);
                (0, chai_1.expect)(typeof dispute.totalVoters === "object"
                    ? dispute.totalVoters.toNumber()
                    : dispute.totalVoters).to.equal(0);
        ...
        describe("initialize_protocol", () => {
            it("Rejects re-initialization of already initialized protocol", async () => {
                ...
                try {
                    const programDataPda = (0, test_utils_1.deriveProgramDataPda)(program.programId);
                    await program.methods
                        .initializeProtocol(51, 100, 1 * web3_js_1.LAMPORTS_PER_SOL)
                        .accountsPartial({
                        protocolConfig: protocolPda,
                        treasury: treasuryPubkey,
                        authority: provider.wallet.publicKey,
            ...
            it("Confirms protocol singleton pattern via PDA", async () => {
                ...
                const [derivedPda] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("protocol")], program.programId);
                (0, chai_1.expect)(derivedPda.toString()).to.equal(protocolPda.toString());
                // Verify it exists
                const config = await program.account.protocolConfig.fetch(protocolPda);
                (0, chai_1.expect)(config.authority.toString()).to.equal(provider.wallet.publicKey.toString());
            });
        });
    });
    describe("Audit Gap Filling (Issues 3 & 4)", () => {
        it("Unauthorized Cancel Rejection (Issue 4)", async () => {
            ...
            const unauthorized = web3_js_1.Keypair.generate();
            await program.methods
                .createTask(Array.from(taskId), new bn_js_1.default(1), Buffer.from("Auth check".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
                escrow: escrowPda,
        ...
        it("Unauthorized Complete Rejection (Issue 4)", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId), new bn_js_1.default(1), Buffer.from("Auth check 2".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
                escrow: escrowPda,
        ...
        it("Cannot Cancel a Completed Task (Rug Pull Prevention) (Issue 3)", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId), new bn_js_1.default(1), Buffer.from("Rug check".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
                escrow: escrowPda,
        ...
        it("Cannot Complete a Cancelled Task (Theft Prevention) (Issue 3)", async () => {
            ...
            const escrowPda = deriveEscrowPda(taskPda);
            await program.methods
                .createTask(Array.from(taskId), new bn_js_1.default(1), Buffer.from("Theft check".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
            null)
                .accountsPartial({
                task: taskPda,
                escrow: escrowPda,
    ...
    describe("Issue #21: Escrow Fund Safety and Lamport Accounting Tests", () => {
        ...
        async function getMinRent(size) {
        ...
        describe("create_task lamport accounting", () => {
            it("Creator balance decreases by exactly reward_amount + rent, escrow has reward_amount", async () => {
                ...
                const tx = await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Escrow accounting test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(actualCreatorDecrease).to.be.closeTo(expectedCreatorDecrease, 500000);
                (0, chai_1.expect)(escrowBalance).to.be.closeTo(escrowRent + rewardAmount, 500000);
                (0, chai_1.expect)(taskBalance).to.be.closeTo(taskRent, 500000);
                // Verify escrow account data
                const escrow = await program.account.taskEscrow.fetch(escrowPda);
                (0, chai_1.expect)(escrow.amount.toNumber()).to.equal(rewardAmount);
                (0, chai_1.expect)(escrow.distributed.toNumber()).to.equal(0);
                (0, chai_1.expect)(escrow.isClosed).to.be.false;
            });
            it("Zero-reward task: rejected with InvalidReward error", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zero reward escrow test".padEnd(64, "\0")), new bn_js_1.default(0), // Zero reward - should fail
                    1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
        ...
        describe("complete_task lamport accounting", () => {
            it("Escrow decreases by reward, worker increases by (reward - fee), treasury increases by fee", async () => {
                ...
                // Create task
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Complete accounting test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(taskAccount.protocolFeeBps).to.equal(PROTOCOL_FEE_BPS, "Task protocol_fee_bps should match protocol config");
                ...
                (0, chai_1.expect)(workerBalanceAfter - workerBalanceBefore).to.be.closeTo(workerReward - txFee, 2500000);
                (0, chai_1.expect)(treasuryBalanceAfter - treasuryBalanceBefore).to.equal(protocolFee);
                // Verify escrow is closed (balance is 0)
                (0, chai_1.expect)(escrowBalanceAfter).to.equal(0);
            });
            it("Collaborative task: reward splits exactly among workers, no dust left", async () => {
                ...
                const rewardAmount = 3 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Collaborative split test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 3, // 3 workers required
                (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(w1After - w1Before + tx1Fee).to.be.closeTo(netRewardPerWorker, 2500000);
                // Escrow should still exist after first completion
                const escrowMid1 = await provider.connection.getAccountInfo(escrowPda);
                (0, chai_1.expect)(escrowMid1).to.not.be.null;
                ...
                (0, chai_1.expect)(escrowMid2).to.not.be.null;
                // Worker 3 completes — final completion closes escrow
                await program.methods
                    .completeTask(Array.from(Buffer.from("proof3".padEnd(32, "\0"))), null)
                    .accountsPartial({
                    task: taskPda,
                    claim: claimPda3,
                    escrow: escrowPda,
                ...
                const task = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(task.status).to.deep.equal({ completed: {} });
                (0, chai_1.expect)(task.completions).to.equal(3);
            });
        });
        describe("cancel_task lamport accounting", () => {
            it("Creator receives exact refund (escrow.amount - escrow.distributed)", async () => {
                ...
                const rewardAmount = 2 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancel refund test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(creatorBalanceAfter - creatorBalanceBefore + txFee).to.be.closeTo(rewardAmount + escrowRent, 50000);
                // Verify escrow is closed (balance is 0)
                (0, chai_1.expect)(escrowBalanceAfter).to.equal(0);
                // Verify task state
                const task = await program.account.task.fetch(taskPda);
            ...
            it("Cannot cancel task with completions > 0 (funds already distributed)", async () => {
                ...
                const shortDeadline = (0, litesvm_helpers_1.getClockTimestamp)(svm) + 2;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Partial refund test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 2, new bn_js_1.default(shortDeadline), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                try {
                    await program.methods
                        ...
                        .signers([creator])
                        .rpc();
                    chai_1.expect.fail("Expected cancel to fail after completion");
                }
                catch (e) {
                    const errorCode = e.error?.errorCode?.code || e.message || "";
                    // Escrow is closed after completion, so either error is valid
                    (0, chai_1.expect)(errorCode.includes("TaskCannotBeCancelled") ||
                        errorCode.includes("AccountNotInitialized")).to.be.true;
                }
            });
        });
        describe("Double withdrawal prevention", () => {
            it("Completing same claim twice fails", async () => {
                ...
                const rewardAmount = 2 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Double complete test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(escrowFinal).to.equal(escrowAfter);
            });
            it("Cancelling completed task fails", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancel completed test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(creatorAfter).to.equal(creatorBefore);
            });
        });
        describe("Escrow close behavior", () => {
            it("After task completion, escrow.is_closed = true, lamports drained correctly", async () => {
                ...
                const rewardAmount = 1 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Escrow close test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const escrowBalance = await provider.connection.getBalance(escrowPda);
                (0, chai_1.expect)(escrowBalance).to.equal(0);
                // Verify creator received the escrow rent (escrow account closed)
                const creatorBalanceAfter = await provider.connection.getBalance(creator.publicKey);
                (0, chai_1.expect)(creatorBalanceAfter).to.be.greaterThan(creatorBalanceBefore);
            ...
            it("After cancel, escrow.is_closed = true", async () => {
                ...
                const escrowRent = await getMinRent(ESCROW_SIZE);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Escrow close on cancel".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("Lamport conservation (no leaks)", () => {
            it("Sum of all balance deltas equals zero (accounting for tx fees)", async () => {
                ...
                // Create task
                const tx1 = await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Conservation test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(totalDelta + newAccountsTotal + totalTxFees).to.be.closeTo(0, 25000);
            });
        });
    });
    describe("Issue #22: Dispute Initiation Correctness Tests", () => {
        ...
        describe("Valid dispute initiation", () => {
            it("Can dispute InProgress task", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Disputable InProgress task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                // Initiate dispute
                await program.methods
                    .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(Buffer.from("evidence-hash".padEnd(32, "\0"))), 0, // Refund type
                test_utils_1.VALID_EVIDENCE)
                    .accountsPartial({
                    dispute: disputePda,
                    task: taskPda,
            ...
            it("Dispute creates with correct voting_deadline (24 hours from creation)", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Deadline verification task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                await program.methods
                    ...
                    .signers([worker.wallet])
                    .rpc();
                const beforeTimestamp = (0, litesvm_helpers_1.getClockTimestamp)(svm);
                await program.methods
                    .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(Buffer.from("evidence".padEnd(32, "\0"))), 1, // Complete type
                test_utils_1.VALID_EVIDENCE)
                    .accountsPartial({
                    dispute: disputePda,
                    task: taskPda,
                    ...
                    .signers([worker.wallet])
                    .rpc();
                const afterTimestamp = (0, litesvm_helpers_1.getClockTimestamp)(svm);
                const dispute = await program.account.dispute.fetch(disputePda);
                // Voting deadline should be >= createdAt (votingPeriod may be 0 or small on test validator)
                (0, chai_1.expect)(dispute.votingDeadline.toNumber()).to.be.at.least(dispute.createdAt.toNumber());
                ...
                const protocolConfig = await program.account.protocolConfig.fetch(protocolPda);
                const actualVotingPeriod = protocolConfig.votingPeriod?.toNumber?.() ||
                    protocolConfig.votingPeriod ||
                    0;
                if (actualVotingPeriod > 0) {
                    // If voting period is set, verify the calculation
                    (0, chai_1.expect)(dispute.votingDeadline.toNumber()).to.equal(dispute.createdAt.toNumber() + actualVotingPeriod);
                }
                // Verify createdAt is reasonable (within range of SVM clock, allowing for clock advances in prior tests)
                (0, chai_1.expect)(dispute.createdAt.toNumber()).to.be.at.least(beforeTimestamp - 300);
                (0, chai_1.expect)(dispute.createdAt.toNumber()).to.be.at.most(afterTimestamp + 300);
            });
            it("Task status changes to Disputed after initiation", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Status change test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(task.status).to.deep.equal({ inProgress: {} });
                await program.methods
                    .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(Buffer.from("evidence".padEnd(32, "\0"))), 2, // Split type
                test_utils_1.VALID_EVIDENCE)
                    .accountsPartial({
                    dispute: disputePda,
                    task: taskPda,
            ...
            it("All resolution types (0, 1, 2) are accepted", async () => {
                ...
                await program.methods
                    .createTask(Array.from(taskId0), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Resolution type 0".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda0,
                    escrow: escrowPda0,
                ...
                await program.methods
                    ...
                    .rpc();
                await program.methods
                    .initiateDispute(Array.from(disputeId0), Array.from(taskId0), Array.from(Buffer.from("evidence".padEnd(32, "\0"))), 0, test_utils_1.VALID_EVIDENCE)
                    .accountsPartial({
                    dispute: disputePda0,
                    task: taskPda0,
                    agent: worker.agentPda,
                ...
                (0, chai_1.expect)(dispute0.resolutionType).to.deep.equal({ refund: {} });
        ...
        describe("Invalid task states for dispute", () => {
            it("Cannot dispute Open task", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Open task dispute test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cannot dispute Completed task", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Completed task dispute test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cannot dispute Cancelled task", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Cancelled task dispute test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cannot dispute already Disputed task (duplicate dispute)", async () => {
                ...
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Double dispute test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                await program.methods
                    .initiateDispute(Array.from(disputeId1), Array.from(taskId), Array.from(Buffer.from("evidence1".padEnd(32, "\0"))), 0, test_utils_1.VALID_EVIDENCE)
                    .accountsPartial({
                    dispute: disputePda1,
                    task: taskPda,
                    agent: worker.agentPda,
                ...
                try {
                    await program.methods
                        .initiateDispute(Array.from(disputeId2), Array.from(taskId), Array.from(Buffer.from("evidence2".padEnd(32, "\0"))), 0, test_utils_1.VALID_EVIDENCE)
                        .accountsPartial({
                        dispute: disputePda2,
                        task: taskPda,
        ...
        describe("Agent validation for dispute initiation", () => {
            it("Inactive agent cannot initiate dispute", async () => {
                ...
                const inactiveOwner = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, inactiveOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(inactiveAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://inactive.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 10))
                    .accountsPartial({
                ...
                (0, chai_1.expect)(agent.status).to.deep.equal({ inactive: {} });
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Inactive agent dispute test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Wrong agent authority rejected", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Wrong authority dispute test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const wrongAuthority = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, wrongAuthority.publicKey, web3_js_1.LAMPORTS_PER_SOL);
                try {
                    await program.methods
                        .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(Buffer.from("evidence".padEnd(32, "\0"))), 0, test_utils_1.VALID_EVIDENCE)
                        .accountsPartial({
        ...
        describe("Invalid resolution type", () => {
            it("resolution_type > 2 is rejected", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Invalid resolution type test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                try {
                    await program.methods
                        .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(Buffer.from("evidence".padEnd(32, "\0"))), 3, // Invalid - only 0, 1, 2 are valid
                    test_utils_1.VALID_EVIDENCE)
                        .accountsPartial({
                        dispute: disputePda,
                        task: taskPda,
                ...
                try {
                    await program.methods
                        .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(Buffer.from("evidence".padEnd(32, "\0"))), 255, test_utils_1.VALID_EVIDENCE)
                        .accountsPartial({
                        dispute: disputePda,
                        task: taskPda,
                        agent: worker.agentPda,
        ...
        describe("Dispute initialization details", () => {
            it("Dispute fields are correctly initialized", async () => {
                ...
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Dispute details test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                await program.methods
                    ...
                    .rpc();
                await program.methods
                    .initiateDispute(Array.from(disputeId), Array.from(taskId), Array.from(evidenceHash), 1, // Complete type
                test_utils_1.VALID_EVIDENCE)
                    .accountsPartial({
                    dispute: disputePda,
                    task: taskPda,
                ...
                const dispute = await program.account.dispute.fetch(disputePda);
                // Verify all fields
                (0, chai_1.expect)(Buffer.from(dispute.disputeId)).to.deep.equal(disputeId);
                (0, chai_1.expect)(dispute.task.toString()).to.equal(taskPda.toString());
                (0, chai_1.expect)(dispute.initiator.toString()).to.equal(worker.agentPda.toString());
                (0, chai_1.expect)(Buffer.from(dispute.evidenceHash)).to.deep.equal(evidenceHash);
                (0, chai_1.expect)(dispute.resolutionType).to.deep.equal({ complete: {} });
                (0, chai_1.expect)(dispute.status).to.deep.equal({ active: {} });
                (0, chai_1.expect)(typeof dispute.votesFor === "object"
                    ? dispute.votesFor.toNumber()
                    : dispute.votesFor).to.equal(0);
                ...
                (0, chai_1.expect)(typeof dispute.totalVoters === "object"
                    ? dispute.totalVoters.toNumber()
                    : dispute.totalVoters).to.equal(0);
                (0, chai_1.expect)(dispute.resolvedAt.toNumber()).to.equal(0);
            });
        });
    });
    describe("Issue #23: Dispute Voting and Resolution Safety Tests", () => {
        ...
        describe("Voting tests", () => {
            it("Only agents with ARBITER capability (1 << 7 = 128) can vote", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Voting capability test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const arbiterOwner = web3_js_1.Keypair.generate();
                const arbiterId = makeAgentId("arb-vote-1");
                const arbiterPda = deriveAgentPda(arbiterId);
                (0, litesvm_helpers_1.fundAccount)(svm, arbiterOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(arbiterId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE | test_utils_1.CAPABILITY_ARBITER), "https://arbiter.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: arbiterPda,
                    protocolConfig: protocolPda,
            ...
            it("Arbiter must have sufficient stake (>= protocol_config.min_arbiter_stake)", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Stake test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const lowStakeOwner = web3_js_1.Keypair.generate();
                const lowStakeId = makeAgentId("arb-lowstk");
                const lowStakePda = deriveAgentPda(lowStakeId);
                (0, litesvm_helpers_1.fundAccount)(svm, lowStakeOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                // Program requires min_arbiter_stake for ARBITER capability registration
                try {
                    await program.methods
                        .registerAgent(Array.from(lowStakeId), new bn_js_1.default(test_utils_1.CAPABILITY_ARBITER), "https://lowstake.example.com", null, new bn_js_1.default(0))
                        .accountsPartial({
                        agent: lowStakePda,
                        protocolConfig: protocolPda,
                        ...
                        .rpc();
                    chai_1.expect.fail("Should have rejected low stake arbiter registration");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("InsufficientStake");
                }
            });
            it("Cannot vote after voting_deadline", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Deadline vote test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, litesvm_helpers_1.fundAccount)(svm, arbiterOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(arbiterId), new bn_js_1.default(test_utils_1.CAPABILITY_ARBITER), "https://arbiter-deadline.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: arbiterPda,
                    protocolConfig: protocolPda,
                    authority: arbiterOwner.publicKey,
            ...
            it("Cannot vote twice on same dispute (PDA prevents duplicate vote accounts)", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Double vote test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, litesvm_helpers_1.fundAccount)(svm, arbiterOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(arbiterId), new bn_js_1.default(test_utils_1.CAPABILITY_ARBITER), "https://arbiter-double.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: arbiterPda,
                    protocolConfig: protocolPda,
                    authority: arbiterOwner.publicKey,
                ...
                (0, chai_1.expect)(votePda.toString()).to.equal(votePda2.toString());
            });
            it("Vote counts (votes_for, votes_against) increment correctly", async () => {
                ...
                await program.methods
                    .registerAgent(Array.from(arbiterId), new bn_js_1.default(test_utils_1.CAPABILITY_ARBITER), "https://arbiter-count.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: arbiterPda,
                    protocolConfig: protocolPda,
                    authority: arbiterOwner.publicKey,
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Vote count test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(typeof disputeBefore.votesFor === "object"
                    ? disputeBefore.votesFor.toNumber()
                    : disputeBefore.votesFor).to.equal(0);
                (0, chai_1.expect)(typeof disputeBefore.votesAgainst === "object"
                    ? disputeBefore.votesAgainst.toNumber()
                    : disputeBefore.votesAgainst).to.equal(0);
                (0, chai_1.expect)(typeof disputeBefore.totalVoters === "object"
                    ? disputeBefore.totalVoters.toNumber()
                    : disputeBefore.totalVoters).to.equal(0);
            });
            it("Active agent status required to vote", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Inactive voter test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const inactiveArbiterOwner = web3_js_1.Keypair.generate();
                const inactiveArbiterId = makeAgentId("arb-inact");
                const inactiveArbiterPda = deriveAgentPda(inactiveArbiterId);
                (0, litesvm_helpers_1.fundAccount)(svm, inactiveArbiterOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(inactiveArbiterId), new bn_js_1.default(test_utils_1.CAPABILITY_ARBITER), "https://inactive-arbiter.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                ...
                (0, chai_1.expect)(arbiter.status).to.deep.equal({ inactive: {} });
                // Check if voting is still active before testing
                const dispute = await program.account.dispute.fetch(disputePda);
                const currentTime = (0, litesvm_helpers_1.getClockTimestamp)(svm);
                ...
                try {
                    await program.methods
                        ...
                        .signers([inactiveArbiterOwner])
                        .rpc();
                    chai_1.expect.fail("Inactive arbiter should not vote");
                }
                catch (e) {
                    ...
                    (0, chai_1.expect)(["AgentNotActive", "VotingEnded"]).to.include(errorCode);
                }
            });
        });
        describe("Resolution tests", () => {
            it("Cannot resolve before voting_deadline", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Early resolve test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Cannot resolve with zero votes (InsufficientVotes)", async () => {
                ...
                const disputePda = deriveDisputePda(disputeId);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zero votes test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const dispute = await program.account.dispute.fetch(disputePda);
                const votesForNum = typeof dispute.votesFor === "object"
                    ? dispute.votesFor.toNumber()
                    : dispute.votesFor;
                const votesAgainstNum = typeof dispute.votesAgainst === "object"
                    ? dispute.votesAgainst.toNumber()
                    : dispute.votesAgainst;
                (0, chai_1.expect)(votesForNum + votesAgainstNum).to.equal(0);
            });
    ...
    describe("Issue #24: Reputation and Stake Safety Tests", () => {
        describe("Reputation tests", () => {
            it("Initial reputation is 5000 (50%)", async () => {
                const newAgentOwner = web3_js_1.Keypair.generate();
                const newAgentId = makeAgentId("rep-test-1");
                const newAgentPda = deriveAgentPda(newAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, newAgentOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(newAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://rep-test.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: newAgentPda,
                    protocolConfig: protocolPda,
            ...
            it("Reputation increases by 100 on task completion", async () => {
                ...
                const repAgentOwner = web3_js_1.Keypair.generate();
                const repAgentId = makeAgentId("rep-test-2");
                const repAgentPda = deriveAgentPda(repAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, repAgentOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(repAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://rep-complete.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: repAgentPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(initialRep).to.equal(5000);
                // Create task, claim, complete
                const taskId = Buffer.from("rep-task-001".padEnd(32, "\0"));
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Reputation increment test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(agent.reputation).to.equal(initialRep + 100);
            });
            it("Reputation caps at 10000 (saturating_add)", async () => {
                // Create agent and complete many tasks to approach cap
                const capAgentOwner = web3_js_1.Keypair.generate();
                const capAgentId = makeAgentId("rep-test-3");
                const capAgentPda = deriveAgentPda(capAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, capAgentOwner.publicKey, 10 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(capAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://rep-cap.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: capAgentPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(agent.reputation).to.equal(5000);
                (0, chai_1.expect)(agent.reputation).to.be.at.most(10000);
            });
            it("Reputation cannot go negative (saturating behavior)", async () => {
                ...
                const negAgentOwner = web3_js_1.Keypair.generate();
                const negAgentId = makeAgentId("rep-test-4");
                const negAgentPda = deriveAgentPda(negAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, negAgentOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(negAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://rep-neg.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: negAgentPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(agent.reputation).to.be.at.least(0);
                (0, chai_1.expect)(agent.reputation).to.be.at.most(10000);
            });
        });
        describe("Stake tests", () => {
            it("Arbiter must have stake >= min_arbiter_stake to vote on disputes", async () => {
                ...
                (0, chai_1.expect)(config.minArbiterStake.toNumber()).to.be.at.least(0);
                // Try to create arbiter with zero stake - should fail
                // The program requires min_arbiter_stake for ARBITER capability
                const zeroStakeOwner = web3_js_1.Keypair.generate();
                const zeroStakeId = makeAgentId("stake-0");
                const zeroStakePda = deriveAgentPda(zeroStakeId);
                (0, litesvm_helpers_1.fundAccount)(svm, zeroStakeOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                try {
                    await program.methods
                        .registerAgent(Array.from(zeroStakeId), new bn_js_1.default(1 << 7), // ARBITER capability
                    "https://zero-stake.example.com", null, new bn_js_1.default(0))
                        .accountsPartial({
                        agent: zeroStakePda,
                        protocolConfig: protocolPda,
                        ...
                        .rpc();
                    chai_1.expect.fail("Should have rejected zero-stake arbiter registration");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("InsufficientStake");
                }
            ...
            it("Stake is tracked in agent.stake field", async () => {
                const stakeAgentOwner = web3_js_1.Keypair.generate();
                const stakeAgentId = makeAgentId("stake-1");
                const stakeAgentPda = deriveAgentPda(stakeAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, stakeAgentOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(stakeAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://stake-track.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: stakeAgentPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(agent.stake).to.not.be.undefined;
                (0, chai_1.expect)(agent.stake.toNumber()).to.equal(web3_js_1.LAMPORTS_PER_SOL);
            });
        });
        describe("Worker stats", () => {
            it("tasks_completed increments on completion", async () => {
                const statsAgentOwner = web3_js_1.Keypair.generate();
                const statsAgentId = makeAgentId("stats-1");
                const statsAgentPda = deriveAgentPda(statsAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, statsAgentOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(statsAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://stats-complete.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: statsAgentPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(agent.tasksCompleted.toNumber()).to.equal(0);
                // Create, claim, complete a task
                const taskId = Buffer.from("stats-task-001".padEnd(32, "\0"));
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Stats increment test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("total_earned tracks cumulative rewards", async () => {
                const earnAgentOwner = web3_js_1.Keypair.generate();
                const earnAgentId = makeAgentId("stats-2");
                const earnAgentPda = deriveAgentPda(earnAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, earnAgentOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(earnAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://stats-earned.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: earnAgentPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(agent.totalEarned.toNumber()).to.equal(0);
                // Complete a task
                ...
                const rewardAmount = 1 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Earnings test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(agent.totalEarned.toNumber()).to.equal(expectedEarned);
            });
            it("active_tasks increments on claim, decrements on completion", async () => {
                const activeAgentOwner = web3_js_1.Keypair.generate();
                const activeAgentId = makeAgentId("stats-3");
                const activeAgentPda = deriveAgentPda(activeAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, activeAgentOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(activeAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://stats-active.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Active tasks test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(agent.activeTasks).to.equal(1);
                // Complete the task
                await program.methods
                    .completeTask(Array.from(Buffer.from("proof".padEnd(32, "\0"))), null)
                    .accountsPartial({
    ...
    describe("Issue #25: Concurrency and Race Condition Simulation Tests", () => {
        describe("Multiple claims", () => {
            it("Multiple workers can claim collaborative task up to max_workers", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Multi-claim test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 33), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("max_workers+1 claim attempt fails (TaskFullyClaimed)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Overflow claim test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                try {
                    await program.methods
                        ...
                        .signers([worker3.wallet])
                        .rpc();
                    chai_1.expect.fail("Third claim should fail");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("TaskFullyClaimed");
                }
                const task = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(task.currentWorkers).to.equal(2);
            });
            it("Concurrent claims don't exceed limit (PDA uniqueness enforces this)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("PDA uniqueness test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
        ...
        describe("Completion races", () => {
            it("First completion on exclusive task wins full reward", async () => {
                ...
                const rewardAmount = 1 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("First wins test".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("Collaborative task: all required completions must happen", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("All completions test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(escrowAccount).to.not.be.null;
        ...
        describe("State consistency", () => {
            it("current_workers count stays accurate across multiple claims", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Worker count test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 33), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("completions count stays accurate across multiple completions", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Completion count test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 33), 3, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                await program.methods
                    ...
                    .rpc();
                let task = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(task.completions).to.equal(0);
            ...
            it("Worker active_tasks count stays consistent", async () => {
                ...
                const trackAgentOwner = web3_js_1.Keypair.generate();
                const trackAgentId = makeAgentId("track-1");
                const trackAgentPda = deriveAgentPda(trackAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, trackAgentOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(trackAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://track.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: trackAgentPda,
                    protocolConfig: protocolPda,
                ...
                await program.methods
                    .createTask(Array.from(taskId1), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Track test 1".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda1,
                    escrow: escrowPda1,
                ...
                await program.methods
                    .createTask(Array.from(taskId2), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Track test 2".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda2,
                    escrow: escrowPda2,
                ...
                await program.methods
                    ...
                    .rpc();
                agent = await program.account.agentRegistration.fetch(trackAgentPda);
                (0, chai_1.expect)(agent.activeTasks).to.equal(2);
                // Complete task 1
                await program.methods
                    .completeTask(Array.from(Buffer.from("proof1".padEnd(32, "\0"))), null)
                    .accountsPartial({
    ...
    describe("Issue #26: Instruction Fuzzing and Invariant Validation", () => {
        describe("Boundary inputs", () => {
            it("max_workers = 100 (max allowed) is valid", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Max workers test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 100, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
            ...
            it("max_workers = 0 should fail (InvalidMaxWorkers)", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zero workers test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 0, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
                    ...
                    (0, chai_1.expect)(e.error?.errorCode?.code || e.message).to.include("InvalidMaxWorkers");
                }
            });
            it("reward_amount = 0 is rejected (InvalidReward)", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Zero reward test".padEnd(64, "\0")), new bn_js_1.default(0), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
                        ...
                        .signers([creator])
                        .rpc();
                    chai_1.expect.fail("Should have rejected zero reward");
                }
                catch (e) {
                    (0, chai_1.expect)(e.error?.errorCode?.code).to.equal("InvalidReward");
                }
            });
            it("reward_amount = very large value should fail (insufficient funds)", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Huge reward test".padEnd(64, "\0")), new bn_js_1.default("18446744073709551615"), // u64::MAX
                    1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
            ...
            it("deadline = 0 should fail with InvalidDeadline (#492)", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("No deadline test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL), 1, new bn_js_1.default(0), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
                        ...
                        .signers([creator])
                        .rpc();
                    chai_1.expect.fail("Should have failed with deadline=0");
                }
                catch (e) {
            ...
            it("deadline in past should fail on creation", async () => {
                ...
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                const pastDeadline = (0, litesvm_helpers_1.getClockTimestamp)(svm) - 3600; // 1 hour ago
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Past deadline test".padEnd(64, "\0")), new bn_js_1.default(0), 1, new bn_js_1.default(pastDeadline), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
            ...
            it("task_type > 2 should fail (InvalidTaskType)", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Invalid type test".padEnd(64, "\0")), new bn_js_1.default(0), 1, new bn_js_1.default(0), 3, null, // Invalid: only 0, 1, 2 are valid
                    0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                    ...
                    (0, chai_1.expect)(e.message).to.include("InvalidTaskType");
                }
            });
            it("capabilities = 0 is rejected (InvalidCapabilities)", async () => {
                const zeroCapOwner = web3_js_1.Keypair.generate();
                const zeroCapId = makeAgentId("fuzz-1");
                const zeroCapPda = deriveAgentPda(zeroCapId);
                (0, litesvm_helpers_1.fundAccount)(svm, zeroCapOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                try {
                    await program.methods
                        .registerAgent(Array.from(zeroCapId), new bn_js_1.default(0), // Zero capabilities - now rejected
                    "https://zero-cap.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                        .accountsPartial({
                        agent: zeroCapPda,
                        protocolConfig: protocolPda,
                        ...
                        .rpc();
                    chai_1.expect.fail("Should have failed with InvalidCapabilities");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("InvalidCapabilities");
                }
            });
            it("capabilities = u64::MAX is valid", async () => {
                const maxCapOwner = web3_js_1.Keypair.generate();
                const maxCapId = makeAgentId("fuzz-2");
                const maxCapPda = deriveAgentPda(maxCapId);
                (0, litesvm_helpers_1.fundAccount)(svm, maxCapOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(maxCapId), new bn_js_1.default("18446744073709551615"), // u64::MAX
                "https://max-cap.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: maxCapPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(rawCapBytes).to.deep.equal([
                    255, 255, 255, 255, 255, 255, 255, 255,
                ]);
            });
            it("Empty strings for endpoint are rejected (InvalidInput)", async () => {
                const emptyStrOwner = web3_js_1.Keypair.generate();
                const emptyStrId = makeAgentId("fuzz-3");
                const emptyStrPda = deriveAgentPda(emptyStrId);
                (0, litesvm_helpers_1.fundAccount)(svm, emptyStrOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                try {
                    await program.methods
                        .registerAgent(Array.from(emptyStrId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "", // Empty endpoint - now rejected
                    "", // Empty metadata
                    new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                        .accountsPartial({
                        agent: emptyStrPda,
                        protocolConfig: protocolPda,
                        ...
                        .rpc();
                    chai_1.expect.fail("Should have failed with InvalidInput");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("InvalidInput");
                }
            });
            it("Max length strings (128 chars) for endpoint - must be valid URL", async () => {
                const maxLenOwner = web3_js_1.Keypair.generate();
                const maxLenId = makeAgentId("fuzz-4");
                const maxLenPda = deriveAgentPda(maxLenId);
                (0, litesvm_helpers_1.fundAccount)(svm, maxLenOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                ...
                await program.methods
                    .registerAgent(Array.from(maxLenId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), maxUrl, null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: maxLenPda,
                    protocolConfig: protocolPda,
                ...
                (0, chai_1.expect)(agent.endpoint.length).to.equal(128);
            });
            it("Over max length strings (129 chars) should fail", async () => {
                const overLenOwner = web3_js_1.Keypair.generate();
                const overLenId = makeAgentId("fuzz-5");
                const overLenPda = deriveAgentPda(overLenId);
                (0, litesvm_helpers_1.fundAccount)(svm, overLenOwner.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                const baseUrl = "https://example.com/";
                const padding = "a".repeat(129 - baseUrl.length);
                const overStr = baseUrl + padding;
                try {
                    await program.methods
                        .registerAgent(Array.from(overLenId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), overStr, // 129 chars - too long
                    null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                        .accountsPartial({
                        agent: overLenPda,
                        protocolConfig: protocolPda,
                    ...
                    (0, chai_1.expect)(e.message).to.satisfy((msg) => msg.includes("StringTooLong") || msg.includes("InvalidInput"));
                }
            });
        });
        describe("Invariant checks", () => {
            it("task.current_workers <= task.max_workers always", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Invariant test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                await program.methods
                    ...
                    .rpc();
                const task = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(task.currentWorkers).to.be.at.most(task.maxWorkers);
            });
            it("task.completions <= task.required_completions always", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Completion invariant".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 50), 2, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_COLLABORATIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                const task = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(task.completions).to.be.at.most(task.requiredCompletions);
            });
            it("escrow.distributed <= escrow.amount always (verified before completion)", async () => {
                ...
                const rewardAmount = 1 * web3_js_1.LAMPORTS_PER_SOL;
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Escrow invariant".padEnd(64, "\0")), new bn_js_1.default(rewardAmount), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(escrowBefore.distributed.toNumber()).to.be.at.most(escrowBefore.amount.toNumber());
                (0, chai_1.expect)(escrowBefore.distributed.toNumber()).to.equal(0); // No distributions yet
                const worker = await createFreshWorker();
                const claimPda = deriveClaimPda(taskPda, worker.agentPda);
                await program.methods
                    .claimTask()
            ...
            it("worker.active_tasks <= 10 always", async () => {
                ...
                const busyAgentOwner = web3_js_1.Keypair.generate();
                const busyAgentId = makeAgentId("busy-1");
                const busyAgentPda = deriveAgentPda(busyAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, busyAgentOwner.publicKey, 15 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(busyAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://busy.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: busyAgentPda,
                    protocolConfig: protocolPda,
                ...
                for (let i = 0; i < 10; i++) {
                    ...
                    const escrowPda = deriveEscrowPda(taskPda);
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from(`Busy task ${i}`.padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                    null)
                        .accountsPartial({
                        task: taskPda,
                        escrow: escrowPda,
                ...
                (0, chai_1.expect)(agent.activeTasks).to.equal(10);
                ...
                await program.methods
                    .createTask(Array.from(taskId11), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Busy task 10".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda11,
                    escrow: escrowPda11,
            ...
            it("Protocol stats only increase (total_tasks, total_agents, completed_tasks)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Stats increase test".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    escrow: escrowPda,
                ...
                (0, chai_1.expect)(configAfter.totalTasks.toNumber()).to.be.greaterThan(totalTasksBefore);
                // Create an agent
                const newAgentOwner = web3_js_1.Keypair.generate();
                const newAgentId = makeAgentId("stats-new");
                const newAgentPda = deriveAgentPda(newAgentId);
                (0, litesvm_helpers_1.fundAccount)(svm, newAgentOwner.publicKey, 5 * web3_js_1.LAMPORTS_PER_SOL);
                await program.methods
                    .registerAgent(Array.from(newAgentId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://stats-agent.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: newAgentPda,
                    protocolConfig: protocolPda,
                    authority: newAgentOwner.publicKey,
                ...
                (0, chai_1.expect)(configAfter.totalAgents.toNumber()).to.be.greaterThan(totalAgentsBefore);
                // Complete a task
                ...
                configAfter = await program.account.protocolConfig.fetch(protocolPda);
                (0, chai_1.expect)(configAfter.completedTasks.toNumber()).to.be.greaterThan(completedTasksBefore);
            });
        });
        describe("PDA uniqueness", () => {
            it("Same task_id + different creator = different task PDA", async () => {
                ...
                const escrowPda1 = deriveEscrowPda(taskPda1);
                await program.methods
                    .createTask(Array.from(sharedTaskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Shared ID test 1".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda1,
                    escrow: escrowPda1,
                ...
                const escrowPda2 = deriveEscrowPda(taskPda2);
                await program.methods
                    .createTask(Array.from(sharedTaskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Shared ID test 2".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, 0, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda2,
                    escrow: escrowPda2,
                ...
                (0, chai_1.expect)(taskPda1.toString()).to.not.equal(taskPda2.toString());
                // Verify both tasks exist
                const task1 = await program.account.task.fetch(taskPda1);
                const task2 = await program.account.task.fetch(taskPda2);
                (0, chai_1.expect)(task1.creator.toString()).to.equal(creator.publicKey.toString());
                (0, chai_1.expect)(task2.creator.toString()).to.equal(worker1.publicKey.toString());
            });
            it("Same agent_id = same agent PDA (cannot register twice)", async () => {
                ...
                const owner1 = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, owner1.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                // First registration succeeds
                await program.methods
                    .registerAgent(Array.from(duplicateId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://duplicate.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                    .accountsPartial({
                    agent: duplicatePda,
                    protocolConfig: protocolPda,
                ...
                const owner2 = web3_js_1.Keypair.generate();
                (0, litesvm_helpers_1.fundAccount)(svm, owner2.publicKey, 2 * web3_js_1.LAMPORTS_PER_SOL);
                try {
                    await program.methods
                        .registerAgent(Array.from(duplicateId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), "https://duplicate2.example.com", null, new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL))
                        .accountsPartial({
                        agent: duplicatePda,
                        protocolConfig: protocolPda,
                    ...
                    (0, chai_1.expect)(e.message).to.include("already in use");
                }
            });
        });
    });
    describe("Reputation System", () => {
        describe("Reputation gate on claim_task", () => {
            it("rejects claim when worker reputation is below task min_reputation", async () => {
                const { wallet: w, agentId: wId, agentPda: wPda, } = await createFreshWorker(test_utils_1.CAPABILITY_COMPUTE);
                // Create task with min_reputation = 6000 (default agent rep is 5000)
                const taskId = makeAgentId(`rep-gate`);
                const taskPda = deriveTaskPda(creator.publicKey, taskId);
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Reputation gated task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
                ...
                try {
                    await program.methods
                        ...
                        .signers([w])
                        .rpc();
                    chai_1.expect.fail("Should have failed with InsufficientReputation");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("InsufficientReputation");
                }
            });
            it("allows claim when worker reputation meets task min_reputation", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Reputation ok task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
                ...
                const taskAccount = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(taskAccount.currentWorkers).to.equal(1);
            });
            it("allows claim when min_reputation is 0 (no gate)", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("No reputation gate".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
        ...
        describe("Task creation validation", () => {
            it("rejects min_reputation > 10000 (InvalidMinReputation)", async () => {
                ...
                try {
                    await program.methods
                        .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Invalid rep task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
                    ...
                    null)
                        ...
                        .signers([creator])
                        .rpc();
                    chai_1.expect.fail("Should have failed with InvalidMinReputation");
                }
                catch (e) {
                    (0, chai_1.expect)(e.message).to.include("InvalidMinReputation");
                }
            });
            it("stores min_reputation on task account", async () => {
                ...
                const escrowPda = deriveEscrowPda(taskPda);
                await program.methods
                    .createTask(Array.from(taskId), new bn_js_1.default(test_utils_1.CAPABILITY_COMPUTE), Buffer.from("Stored rep task".padEnd(64, "\0")), new bn_js_1.default(web3_js_1.LAMPORTS_PER_SOL / 100), 1, (0, test_utils_1.getDefaultDeadline)(), test_utils_1.TASK_TYPE_EXCLUSIVE, null, // constraint_hash
                7500, // min_reputation
                null)
                    .accountsPartial({
                    task: taskPda,
                    ...
                    .rpc();
                const taskAccount = await program.account.task.fetch(taskPda);
                (0, chai_1.expect)(taskAccount.minReputation).to.equal(7500);
            });
        });
    });
});
