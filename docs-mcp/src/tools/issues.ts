...
export function registerIssueTools(server: McpServer, resolver: IssueResolver): void {
  server.tool(
    ...
    'Get full implementation context for a specific legacy runtime-roadmap issue. Returns roadmap description, files to create/modify, dependencies, existing patterns to follow, key interfaces, and phase documentation.',
