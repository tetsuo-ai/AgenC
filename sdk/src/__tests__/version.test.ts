...
function makeProgram(onChainVersion: number, onChainMinVersion: number): Program {
...
describe('version compatibility', () => {
  ...
  it('requireVersionCompatibility throws for incompatible version', async () => {
    await expect(requireVersionCompatibility(makeProgram(2, 2))).rejects.toThrow('SDK protocol version');
  });
