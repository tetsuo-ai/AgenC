...
| 6 | Silent error in `verifyProofLocally` | `sdk/src/proofs.ts:354-357` | Hides genuine errors as "invalid proof" | Catch specific proof verification errors (NOTE: legacy-js-prover replaced by RISC Zero) |
