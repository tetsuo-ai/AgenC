...
| Silent error swallowing in `verifyProofLocally` | `proofs.ts:354-357` | Hides genuine errors (OOM, I/O) as "invalid proof" | Catch specific legacy-js-prover errors, rethrow unexpected |
