...
| Silent error swallowing in `verifyProofLocally` | `proofs.ts:354-357` | Hides genuine errors (OOM, I/O) as "invalid proof" | Catch specific proof verification errors, rethrow unexpected (NOTE: legacy-js-prover replaced by RISC Zero) |
