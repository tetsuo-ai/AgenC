...
| ~~Hardcoded timeouts~~ | `sdk/src/privacy.ts:266,270` | ~~Can't adjust~~ | **RESOLVED** - Extracted to `NARGO_EXECUTE_TIMEOUT_MS` and `SUNSPOT_PROVE_TIMEOUT_MS` in `constants.ts` |
